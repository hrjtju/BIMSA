...
class SimpleCNNSmall_4Layer(nn.Module):
    ...
    def __init__(self):
        ...
        self.bn2 = nn.BatchNorm2d(8)
        self.act2 = nn.ReLU()
        self.conv3 = nn.Conv2d(8, 8, kernel_size=3, stride=1, padding=1, padding_mode="circular")
        self.bn3 = nn.BatchNorm2d(8)
        self.act3 = nn.ReLU()
        self.conv4 = nn.Conv2d(8, 2, kernel_size=3, stride=1, padding=1, padding_mode="circular")
        # 可选：self.bn3 = nn.BatchNorm2d(2)
