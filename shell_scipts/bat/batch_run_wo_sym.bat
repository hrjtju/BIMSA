...
python .\predictor_life_simple\train_test.py -r "B3/S23" -p ".\predictor_life_simple\hyperparams\small_3_layer_seq_p4mcnn.toml"
...
git add .
git commit -m "更新大实验结果 （CNN, P4CNN, P4MCNN）"
git push --verbose
