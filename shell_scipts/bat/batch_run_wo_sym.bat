...
@REM python .\predictor_life_simple\train_test.py -r "B3/S23" -p ".\predictor_life_simple\hyperparams\small_3_layer_seq_p4cnn.toml"
@REM python .\predictor_life_simple\train_test.py -r "B36/S23" -p ".\predictor_life_simple\hyperparams\small_3_layer_seq_p4cnn.toml"
@REM python .\predictor_life_simple\train_test.py -r "B3678/S34678" -p ".\predictor_life_simple\hyperparams\small_3_layer_seq_p4cnn.toml"
...
@REM python .\predictor_life_simple\train_test.py -r "B3/S23" -p ".\predictor_life_simple\hyperparams\small_3_layer_seq_cnn.toml"
@REM python .\predictor_life_simple\train_test.py -r "B36/S23" -p ".\predictor_life_simple\hyperparams\small_3_layer_seq_cnn.toml"
@REM python .\predictor_life_simple\train_test.py -r "B3678/S34678" -p ".\predictor_life_simple\hyperparams\small_3_layer_seq_cnn.toml"
...
@REM python .\predictor_life_simple\train_test.py -r "B13/S012V" -p ".\predictor_life_simple\hyperparams\small_3_layer_seq_p4cnn.toml"
@REM python .\predictor_life_simple\train_test.py -r "B2/S013V" -p ".\predictor_life_simple\hyperparams\small_3_layer_seq_p4cnn.toml"
